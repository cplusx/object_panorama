...
def _rgb_strip(rep: LayeredSphericalRepresentation) -> np.ndarray:
...
def _depth_layer_images(rep: LayeredSphericalRepresentation) -> list[np.ndarray]:
...
def _depth_strip(rep: LayeredSphericalRepresentation) -> np.ndarray:
    return _tile_layer_images(_depth_layer_images(rep))


def _first_hit_depth_image(rep: LayeredSphericalRepresentation) -> np.ndarray:
...
def _normal_strip(rep: LayeredSphericalRepresentation) -> np.ndarray:
...
def _build_training_representation(
    rep: LayeredSphericalRepresentation,
    include_rgb: bool,
    include_normal: bool,
